...
var getServiceObj = {
   ...
   studenttblUnique:{
    ...
    sessiontbl:{
           query:"SELECT * FROM cubicdb.sessiontbl",
           url:basePath+"/sessiontbl",
           ids:[]
      },
    sessiontblWithTeacher:{
        query : "SELECT * FROM cubicdb.sessiontbl s, cubicdb.teachertbl t where s.teacherId = t.teacherId",
        url: basePath+"/sessionteacher",
        ids: []
    },
    sessiontblUnique:{
        query:"SELECT * FROM cubicdb.sessiontbl where sessionId=?",
        url:basePath+"/sessiontbl/:sessionId",
        ids:["sessionId"]
    } 
};
